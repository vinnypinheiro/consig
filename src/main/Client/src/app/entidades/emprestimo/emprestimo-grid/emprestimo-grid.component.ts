...
@Component({ 
  ...
  templateUrl: './emprestimo-grid.component.html',
  //styleUrls: ['./Emprestimo-grid.component.css']
}) 
export class EmprestimoGridComponent extends CommonsGrid<Emprestimo> implements OnInit {

     constructor(apiService: EmprestimoService, router: Router) {
