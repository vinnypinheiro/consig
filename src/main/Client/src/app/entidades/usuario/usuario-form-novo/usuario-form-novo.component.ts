...
@Component({
  selector: 'gov-asasasas-form-novo',
  templateUrl: './usuario-form-novo.component.html',
  //styleUrls: ['./Usuario-form.component.css']
})
export class UsuarioFormNovoComponent extends CommonsForm<Usuario> implements OnInit, AfterViewInit {
