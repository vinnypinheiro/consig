...
@Component({ 
  selector: 'gov-relatorioAlba-grid',
  templateUrl: './relatorioAlba-grid.component.html',
  //styleUrls: ['./relatorioAlba-grid.component.css']
}) 
export class RelatorioalbaGridComponent extends CommonsGrid<RelatorioAlba> implements OnInit {

     constructor(apiService: RelatorioalbaService, router: Router) {
     ...
     getRowFilter(): FilterData { 
         let filter= this.buildRowFilter('trb_relatorioAlba');
     ...
     getFieldList(): FieldSearch[] { 
         ...
         retorno[2] = new FieldSearch('bancorelatorioAlba','bancorelatorioAlba','STRING');
