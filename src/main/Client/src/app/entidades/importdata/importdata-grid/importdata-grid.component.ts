...
@Component({ 
  selector: 'gov-importdata-grid', 
  templateUrl: './importdata-grid.component.html', 
  //styleUrls: ['./importdata-grid.component.css'] 
}) 
export class ImportdataGridComponent extends CommonsGrid<Importdata> implements OnInit {

     constructor(apiService: ImportdataService, router: Router) {
     ...
     getRowFilter(): FilterData { 
         let filter= this.buildRowFilter('trb_importdata'); 
     ...
     getFieldList(): FieldSearch[] { 
         ...
         retorno[2] = new FieldSearch('bancoimportdata','bancoimportdata','STRING'); 
