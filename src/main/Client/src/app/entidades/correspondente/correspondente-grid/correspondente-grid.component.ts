...
@Component({ 
  selector: 'gov-correspondente-grid', 
  templateUrl: './correspondente-grid.component.html', 
  //styleUrls: ['./correspondente-grid.component.css'] 
}) 
export class CorrespondenteGridComponent extends CommonsGrid<Correspondente> implements OnInit { 

     constructor(apiService: CorrespondenteService, router: Router) { 
     ...
     getRowFilter(): FilterData { 
         let filter= this.buildRowFilter('trb_correspondente'); 
     ...
     getFieldList(): FieldSearch[] { 
         ...
         retorno[2] = new FieldSearch('bancocorrespondente','bancocorrespondente','STRING'); 
