...
const routes: Routes = [
    ...
    {path: 'logout', component: LogoutComponent, canActivate: [AuthGuard]},
    {
        ...
        "children": [
           ...
           { path: 'contapagar', loadChildren: './entidades/contapagar/contapagar.module#ContaPagarModule' },
           { path: 'contareceber', loadChildren: './entidades/contareceber/contareceber.module#ContaReceberModule' },
